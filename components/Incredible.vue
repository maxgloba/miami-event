  ...
  <section class="topics anim">
    <div class="container">
      <div class="topics-title">
        ...
        <h2>Incredible <br> Lineup Of <br> Speakers <br> And Topics</h2>
      </div>
    ...
    sliderAnimate(delta){
      ...
      if(delta > 0){
        ...
        if(this.goToSchedule){
          document.querySelector('.reviews').scrollIntoView({block: "start", behavior: "smooth"})
        }
        ...
        if (delta > 0){
          ...
          document.querySelector('.goes').scrollIntoView({block: "start", behavior: "smooth"});
        }
      }
      setTimeout(()=>{
        this.wheel = false
